  ...
  _createClass(LayerListItem, [{
    ...
    value: function render() {
      return React.createElement(
        'li',
        null,
        React.createElement('input', { type: 'checkbox', checked: this.state.checked, onChange: this.handleChange.bind(this) }),
        this.props.title
      );
    }
  }]);
...
var LayerList = (function (_React$Component2) {
  ...
  _inherits(LayerList, _React$Component2);

  _createClass(LayerList, [{
    key: 'render',
    value: function render() {
      var layerNodes = this.props.map.getLayers().getArray().map(function (lyr, idx) {
        return React.createElement(LayerListItem, { key: idx, layer: lyr, title: lyr.get('title') });
      });
      return React.createElement(
        'ul',
        null,
